...
<body class="bg-white text-gray-800 font-sans relative overflow-x-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-white to-gray-50">
            <svg class="absolute inset-0 w-full h-full" viewBox="0 0 800 400" preserveAspectRatio="xMidYMid meet" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <nav class="relative z-10 bg-blue-900 text-white">
        <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between flex-wrap">
    ...
    <section class="relative z-10 text-center px-4 py-20 md:py-32 bg-cover bg-center"
             style="background-image: url('https://img.freepik.com/premium-vector/abstract-financial-chart-with-uptrend-line-graph-stock-market-grey-background-vector-design_546559-442.jpg');">
        <div class="bg-white bg-opacity-80 py-10 px-4 md:px-8 rounded-lg max-w-4xl mx-auto">
            <h1 class="text-3xl sm:text-4xl md:text-6xl font-light mb-4 leading-tight">Transform Your Data, Empower Your Business</h1>
            <p class="text-gray-700 text-base sm:text-lg mb-8">Professional data analytics and cleaning solutions for your business.</p>
            <div class="flex flex-wrap justify-center gap-4">
                <a href="#services" class="bg-gray-800 text-white px-6 py-3 rounded hover:bg-gray-700 transition text-sm md:text-base">Get Started</a>
                <a href="#contact" class="bg-yellow-400 text-gray-800 px-6 py-3 rounded hover:bg-yellow-300 transition text-sm md:text-base">Contact Us</a>
            </div>
        </div>
    </section>
    ...
    <section id="about" class="relative z-10 py-16 bg-white text-center px-4">
        <div class="flex flex-col md:flex-row items-center justify-center max-w-6xl mx-auto">
            <div class="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                ...
                <a href="{{ route('about') }}" class="text-white bg-blue-600 px-5 py-2 rounded hover:bg-blue-500 transition">Learn More</a>
            </div>
            <div class="md:w-1/2 w-full">
                <img src="https://img.freepik.com/premium-photo/young-african-male-with-laptop-work-home-office_769609-1593.jpg?w=740"
    ...
    <section id="services" class="relative z-10 py-16 bg-gray-50 text-center px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div class="bg-white p-6 rounded shadow">
                <img src="https://img.freepik.com/premium-photo/digital-financial-graph-code-modern-white-background-3d-rendering_670147-114427.jpg?w=740" alt="Dashboards" class="mb-4 rounded w-full h-40 object-cover">
