...
<div class="container about-section mt-4">
    ...
    <div class="row mt-5">
        <div class="col-md-6">
            ...
            <img src="https://thumbs.dreamstime.com/b/financial-report-laptop-black-business-man-his-office-finance-analyst-data-graph-employee-desk-insight-fintech-278378662.jpg?w=768" alt="Data Analytics Team" class="img-fluid mb-4">
            
            <h3>Our Vision</h3>
            <p>To become a leading data consultancy recognized for innovation, precision, and trust in the data industry.</p>
            <img src="https://img.freepik.com/free-photo/desk-scene-with-laptop_23-2147626521.jpg?ga=GA1.1.341280457.1747978859&semt=ais_hybrid&w=740" alt="Company Growth Chart" class="img-fluid mb-4">
